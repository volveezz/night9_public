...
exports.default = {
    ...
    callback: (_client, interaction, _member, _guild, _channel) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const optionId = interaction instanceof discord_js_1.ChatInputCommandInteraction
            ? interaction.options.getString("bungiename")
            : null;
        var targetId = interaction instanceof discord_js_1.ChatInputCommandInteraction
            ? optionId
                ? undefined
                : interaction.user.id
            : interaction.targetId;
        const targetName = optionId
            ? []
            : (_a = interaction.guild.members.cache.get(targetId)) === null || _a === void 0 ? void 0 : _a.displayName;
        const targetAvatar = optionId
            ? undefined
            : (_b = interaction.guild.members.cache.get(targetId)) === null || _b === void 0 ? void 0 : _b.displayAvatarURL();
        if (optionId) {
            ...
            if (bName.length === 2) {
                ...
                yield (0, request_promise_native_1.post)(`https://www.bungie.net/Platform/User/Search/GlobalName/0/`, {
                    ...
                    return yield response.Response.searchResults.forEach((result) => __awaiter(void 0, void 0, void 0, function* () {
                        if (result.bungieGlobalDisplayName == bName[0] &&
                            result.bungieGlobalDisplayNameCode == bName[1]) {
                ...
                const reportPlatform = platform === 3
                    ? "pc"
                    : platform === 2
                        ? "ps"
                        : platform === 1
                ...
                embed.setColor("Green").addFields([
                    {
                        name: "Ссылки",
                        value: `[Trials.Report](https://trials.report/report/${platform}/${bungie_id}), [Raid.Report](https://raid.report/${reportPlatform}/${bungie_id}), [Crucible.Report](https://crucible.report/report/${platform}/${bungie_id}), [Strike.Report](https://strike.report/${reportPlatform}/${bungie_id}), [DestinyTracker](https://destinytracker.com/destiny-2/profile/${platform === 3
                            ? "steam"
                            : platform === 2
                                ? "psn"
                                : platform === 1
                                    ? "xbl"
                                    : "stadia"}/${bungie_id}/overview), [WastedonDestiny](https://wastedondestiny.com/${bungie_id})`,
                    },
                ]);
                return interaction.editReply({ embeds: [embed] });
            }
        ...
        if (data !== null) {
            ...
            const components = [
                new discord_js_1.ButtonBuilder()
                    .setCustomId("stats_old_events")
                    .setLabel("Статистика старых ивентов")
                    .setStyle(discord_js_1.ButtonStyle.Secondary),
                new discord_js_1.ButtonBuilder()
                    .setCustomId("stats_pinnacle")
                    .setLabel("Доступная сверхмощка")
                    .setStyle(discord_js_1.ButtonStyle.Secondary),
            ];
            ...
            (0, request_promise_native_1.get)(`https://www.bungie.net/Platform/Destiny2/${platform}/Profile/${bungie_id}/?components=100`, {
                ...
                if (!data) {
                    embed
                        .setTitle("Произошла ошибка со стороны Bungie")
                        .setColor("Red");
                ...
                (0, request_promise_native_1.get)(`https://www.bungie.net/Platform/GroupV2/User/${platform}/${bungie_id}/0/1/`, {
                    ...
                    if (err)
                        return console.log(err);
                    const clanStatus = ((_a = clanBody.Response.results[0]) === null || _a === void 0 ? void 0 : _a.group.groupId) ===
                        "4123712"
                        ? `Участник клана`
                        : clanBody.Response.results[0]
                            ...
                            : `не состоит в клане`;
                    embed.addFields([
                        { name: `Клан`, value: clanStatus, inline: true },
                    ]);
                    return interaction.editReply({ embeds: [embed] });
