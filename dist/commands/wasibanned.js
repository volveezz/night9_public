...
const SlashCommand = new Command({
    ...
    run: async ({ interaction }) => {
        ...
        embed.setTitle(textNotification).setFooter({
            text: `API Status: ${getEndpointStatus("account")}|${getEndpointStatus("activity")}|${getEndpointStatus("api")}|${getEndpointStatus("oauth")}|${tokenRefresher.wasRefreshedRecently()} | Banned amount: ${longOffline.size}`,
        });
