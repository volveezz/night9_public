export var RaidButtons;
(function (RaidButtons) {
    RaidButtons["join"] = "raidButton_action_join";
    RaidButtons["leave"] = "raidButton_action_leave";
    RaidButtons["alt"] = "raidButton_action_alt";
    RaidButtons["notify"] = "raidInChnButton_notify";
    RaidButtons["delete"] = "raidInChnButton_delete";
    RaidButtons["deleteConfirm"] = "raidAddFunc_delete_confirm";
    RaidButtons["deleteCancel"] = "raidAddFunc_delete_cancel";
    RaidButtons["transfer"] = "raidInChnButton_transfer";
    RaidButtons["unlock"] = "raidInChnButton_unlock";
    RaidButtons["resend"] = "raidInChnButton_resend";
    RaidButtons["notificationsStart"] = "raidNotifications_start";
    RaidButtons["notificationsShowModal"] = "raidNotifications_showModal";
    RaidButtons["notificationsTime"] = "raidNotifications_modal_time";
    RaidButtons["notificationsConfirmModal"] = "changeCustomRaidNotifications";
...
(function (ClanJoinButtons) {
    ...
    ClanJoinButtons["modalUsername"] = "clanJoinEvent_modal_username";
    ClanJoinButtons["modalAge"] = "clanJoinEvent_modal_age";
