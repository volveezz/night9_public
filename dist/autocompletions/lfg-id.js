...
const AutocompleteFile = new Autocomplete({
    ...
    run: async ({ interaction }) => {
        const ids = LFGController.getInstance().findAvailableLfgIdsForUser(interaction.memberPermissions?.has("Administrator") ? undefined : interaction.user.id);
...
//# sourceMappingURL=lfg-id.js.map