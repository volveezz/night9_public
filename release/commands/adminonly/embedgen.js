            ...
            switch (preset) {
                ...
                case "clanjoin": {
                    const embed = new EmbedBuilder()
                        ...
                        .setDescription("Для вступления в клан достаточно выполнить пункты ниже. Если вы нам подходите, то будете автоматически приняты в течение 3-х минут")
                        .addFields({
                        name: "1",
