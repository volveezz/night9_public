import { GuildBan, GuildMember, Message, PartialGuildMember } from "discord.js";
...
interface DeleteLeavedUserDataI {
	discordMessage: Message;
	discordMember: GuildMember | PartialGuildMember | GuildBan;
}

async function removeUserAndSaveLeavedData({ discordMessage, discordMember }: DeleteLeavedUserDataI) {
...
function addFieldsToEmbed(embed: any, fields: Record<string, string>) {
