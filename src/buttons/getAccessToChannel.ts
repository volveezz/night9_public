import { ChannelType, EmbedBuilder, GuildBasedChannel, PrivateThreadChannel, PublicThreadChannel } from "discord.js";
...
function isThreadChannel(channel: GuildBasedChannel): channel is PrivateThreadChannel | PublicThreadChannel<boolean> {
